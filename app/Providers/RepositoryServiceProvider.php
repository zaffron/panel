...
use Pterodactyl\Repositories\Eloquent\SubuserPermissionRepository;
...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(SubuserPermissionRepositoryInterface::class, SubuserPermissionRepository::class);
